...
namespace VNPost.DataAccess.Migrations
{
    public partial class AddDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PermissionCURDs",
                columns: table => new
                {
                    RolePermissionId = table.Column<int>(nullable: false),
                    CRUDId = table.Column<int>(nullable: false),
                    CURDId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.ForeignKey(
                        name: "FK_PermissionCURDs_CURDs_CURDId",
                        column: x => x.CURDId,
                        principalTable: "CURDs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PermissionCURDs_RolePermissions_RolePermissionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "13d23c51-re38-4831-wqa2-2e3f21c23ewd", "9d93fed2-8e54-4c92-b3dc-a1c236b2a36a", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "01b96c14-de28-4831-afa9-3d1f84b93aed", 0, "d882fc4a-4485-43b2-8dde-d94bc192feaf", "polopalay@gmail.com", true, false, null, "POLOPALAY@GMAIL.COM", "POLOPALAY@GMAIL.COM", "AQAAAAEAACcQAAAAEI2rNt77YvirvqeMB4vQ/CinWEN+kXmoaWNZEEQaXqup94Ko9xg6k9he3Bb/96UM6Q==", null, false, "0d93973f-c47d-47fc-a5f9-6994bdeb95c2", false, "polopalay@gmail.com" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Img", "Name" },
                values: new object[] { 1, "http://www.vnpost.vn/ImageCaching.ashx?file=%2fPortals%2f0%2fDichVu%2f02+-+Buu+dien+Viet+Nam+-+Product.png&size=3&ver=5", "Bưu chính chuyển phát" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Img", "Name" },
                values: new object[] { 2, "http://www.vnpost.vn/ImageCaching.ashx?file=%2fPortals%2f0%2fDichVu%2fA022_C056_0106MU.0000339-edit.png&size=3&ver=5", "Tài chính bưu chính" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Img", "Name" },
                values: new object[] { 3, "http://www.vnpost.vn/ImageCaching.ashx?file=%2fPortals%2f0%2fDichVu%2f02+-+Buu+dien+Viet+Nam+(5)-+Product.png&size=3&ver=6", "Phân phối - Truyền thông" });
            ...
            migrationBuilder.InsertData(
                table: "MenuLocations",
                columns: new[] { "Id", "Descrtiption", "Name" },
                values: new object[] { 1, null, "TopMenu" });

            migrationBuilder.InsertData(
                table: "MenuLocations",
                columns: new[] { "Id", "Descrtiption", "Name" },
                values: new object[] { 2, null, "MainMenu" });

            migrationBuilder.InsertData(
                table: "MenuLocations",
                columns: new[] { "Id", "Descrtiption", "Name" },
                values: new object[] { 3, null, "Tra cứu - Định vị" });
            ...
            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 12, "", "/Posts/Write/Index", 4, "Bài viết" });
            ...
            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 36, "", "#", 9, "http://www.vnpost.vn/Portals/0/banner/IT-Banner-02.jpg" });
            ...
            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 35, "", "#", 9, "http://www.vnpost.vn/Portals/0/banner/Banner%20Chao%20mung%20DH%20Dang.jpg" });

            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 37, "", "#", 9, "http://www.vnpost.vn/Portals/0/banner/Tem-COVID.jpg" });

            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 38, "", "#", 9, "http://www.vnpost.vn/Portals/0/banner/Banner%20Cong%20PostGreen.jpg" });
            ...
            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 18, "fas fa-qrcode", "#", 3, "Mã địa chỉ bưu chính" });
            ...
            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 17, "fas fa-search-plus", "#", 3, "Tra cứu kỳ cước KHL" });

            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 3, "Contact", "#", 1, "Liên hệ" });

            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 15, "fas fa-map", "#", 3, "Mạng lưới bưu cục" });

            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 16, "fas fa-ban", "#", 3, "Tra cứu hàng cấm gửi" });

            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 2, "QAndA", "#", 1, "Hỏi đáp" });
            ...
            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 1, "Description", "#", 1, "Giới thiệu" });
            ...
            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 13, "fas fa-map-marker-alt", "#", 3, "Định Vị Bưu Gửi" });

            migrationBuilder.InsertData(
                table: "MenuLinks",
                columns: new[] { "Id", "Key", "Link", "LocationId", "Value" },
                values: new object[] { 14, "fas fa-money-bill-alt", "#", 3, "Định vị chuyển tiền" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 6, "Truyền thông quảng cáo qua các xuất bản phẩm, hệ thống truyền thông quảng cáo ngoài trời, tại các bưu cục, trên các phương tiện vận tải, phong bì...", "http://www.vnpost.vn/ImageCaching.ashx?file=%2fPortals%2f0%2ftruyen-thong-quang-cao.jpg&size=3&ver=8", 3, "Truyền thông, quảng cáo" });

            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Description", "DescriptionImg", "GalleryId", "Title" },
                values: new object[] { 5, "POSTMART là sàn giao dịch thương mại điện tử được sáng lập bởi Tổng Công ty Bưu Điện Việt Nam (VNPost) và vận hành bởi Công ty Phát hành báo chí TW.", "http://www.vnpost.vn/ImageCaching.ashx?file=%2fPortals%2f0%2fviber_image_2019-06-06_14-38-15.jpg&size=3&ver=8", 3, "Sàn thương mại điện tử POSTMART" });
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Description", "DescriptionImg", "GalleryId", "Title" },
                values: new object[] { 3, "Là dịch vụ giới thiệu, chào bán bảo hiểm, thu xếp việc giao kết hợp đồng bảo hiểm thông qua mạng lưới bưu cục, điểm cung cấp dịch vụ của Tổng Công ty Bưu điện Việt Nam.", "http://www.vnpost.vn/ImageCaching.ashx?file=%2fPortals%2f0%2fbh-phi-nhan-tho-pti.jpg&size=3&ver=5", 2, "Bảo hiểm phi nhân thọ PTI" });

            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Description", "DescriptionImg", "GalleryId", "Title" },
                values: new object[] { 2, "Bưu phẩm bảo đảm là dịch vụ chấp nhận, vận chuyển và phát bưu phẩm đến địa chỉ nhận trong nước và quốc tế; bưu phẩm được gắn số hiệu để theo dõi, định vị trong quá trình chuyển phát.", "http://www.vnpost.vn/ImageCaching.ashx?file=%2fPortals%2f0%2fDichVu%2fbuu-pham-dam-bao.jpg&size=3&ver=7", 1, "Bưu phẩm đảm bảo" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionCURDs_CURDId",
                table: "PermissionCURDs",
                column: "CURDId");

            migrationBuilder.CreateIndex(
                name: "IX_PermissionCURDs_RolePermissionId",
                table: "PermissionCURDs",
