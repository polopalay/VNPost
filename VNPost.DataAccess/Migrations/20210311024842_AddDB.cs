        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DescriptionImg = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnistId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointAway = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", "/image/slider/banner1.jpg", "#" },
                    { 2, "", "/image/slider/banner2.jpg", "#" },
                    { 3, "", "/image/slider/banner3.jpg", "#" },
                    { 4, "", "/image/slider/banner4.jpg", "#" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "/image/category/ImageCaching.ashx-2.png", "Tài chính bưu chính" },
                    { 3, "/image/category/ImageCaching.ashx-3.png", "Phân phối - Truyền thông" },
                    { 1, "/image/category/ImageCaching.ashx.png", "Bưu chính chuyển phát" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 13, 3, "Viết thư UPU" },
                    { 20, 2, "Bưu điện - Văn hóa xã" },
                    { 19, 4, "Góp ý xây dựng cơ chế - chính sách" },
                    { 18, 4, "Đoàn thanh niên" },
                    { 17, 4, "Công đoàn" },
                    { 16, 4, "Công tác Đảng" },
                    { 15, 3, "Tìm hiểu Tem Bưu chính" },
                    { 14, 3, "Cuộc thi ảnh bưu điện trong tôi" },
                    { 12, 3, "Hoạt động cộng đồng" },
                    { 11, 3, "Gương điển hình" },
                    { 1, 0, "Tin Vietnam Post" },
                    { 10, 1, "Bưu chính thế giới" },
                    { 3, 0, "Người bưu điện" },
                    { 4, 0, "Hoạt động Đảng - Đoàn thể" },
                    { 5, 1, "Hoạt động ngành" },
                    { 2, 0, "Bưu điện - Văn hóa xã" },
                    { 7, 1, "Hành chính công" },
                    { 8, 1, "Lương hưu - bảo trợ xã hội" },
                    { 9, 1, "Điểm chi trả chế độ BHXH" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 8, "", "/Posts/Service/List/1", "Bưu chính chuyển phát" },
                    { 9, "", "/Posts/Service/List/2", "Tài chính bưu chính" },
                    { 10, "", "/Posts/Service/List/3", "Phân phối -Truyền thông" },
                    { 11, "", "/Posts/Article/List", "Tin tức" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Là dịch vụ chuyển phát nhanh thư, tài liệu, vật phẩm, hàng hóa từ người gửi đến người nhận giữa Việt Nam trong nước và các nước trên thế giới trong khuôn khổ Liên minh Bưu chính Thế giới (UPU) và Hiệp hội EMS theo chỉ tiêu thời gian được Công ty Cổ phần Chuyển Phát Nhanh Bưu điện công bố trước. Chi tiết xin tham khảo tại website: www.ems.com.vn", "/image/post/ImageCaching.ashx.jpeg", "Chuyển phát nhanh EMS" },
                    { 2, 1, "Bưu phẩm bảo đảm là dịch vụ chấp nhận, vận chuyển và phát bưu phẩm đến địa chỉ nhận trong nước và quốc tế; bưu phẩm được gắn số hiệu để theo dõi, định vị trong quá trình chuyển phát.", "/image/post/ImageCaching.ashx-2.jpeg", "Bưu phẩm đảm bảo" },
                    { 3, 2, "Là dịch vụ giới thiệu, chào bán bảo hiểm, thu xếp việc giao kết hợp đồng bảo hiểm thông qua mạng lưới bưu cục, điểm cung cấp dịch vụ của Tổng Công ty Bưu điện Việt Nam.", "/image/post/ImageCaching-3.ashx.jpeg", "Bảo hiểm phi nhân thọ PTI" },
                    { 4, 2, "Là dịch vụ cho phép khách hàng nộp tiền phí bảo hiểm, vay trả góp, tiền điện, nước, cước điện thoại, tiền đặt chỗ, mua hàng qua mạng, tiền phí phạt vi phạm giao thông, tiền thuế, tiền lệ phí hồ sơ xét tuyển ĐH,CĐ, tiền cấp đổi CMND, Hộ chiếu, tiền đặt vé máy bay…tại bưu cục", "/image/post/ImageCaching-4.ashx.jpeg", "Thu hộ - Chi hộ" },
                    { 5, 3, "POSTMART là sàn giao dịch thương mại điện tử được sáng lập bởi Tổng Công ty Bưu Điện Việt Nam (VNPost) và vận hành bởi Công ty Phát hành báo chí TW.", "/image/post/ImageCaching-5.ashx.jpeg", "Sàn thương mại điện tử POSTMART" },
                    { 6, 3, "Truyền thông quảng cáo qua các xuất bản phẩm, hệ thống truyền thông quảng cáo ngoài trời, tại các bưu cục, trên các phương tiện vận tải, phong bì...", "/image/post/ImageCaching-6.ashx.jpeg", "Truyền thông, quảng cáo" }
                });
